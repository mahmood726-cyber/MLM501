...
doc.add_heading('Competing interests', 2)
doc.add_paragraph('The authors declare that no competing interests were disclosed.')
doc.add_heading('Grant information', 2)
doc.add_paragraph('No specific grant was declared for this manuscript draft.')
doc.add_heading('Author contributions', 2)
doc.add_paragraph('Mahmood Ahmad: conceptualization, software curation, writing, review, and editing. Niraj Kumar, Laiba Khan, Bilaal Dar, Andrew Woo: review, editing and project validation.')
doc.add_heading('Acknowledgements', 2)
doc.add_paragraph('The authors acknowledge contributors to open statistical methods, the metafor R package developers, and browser-based scientific visualization ecosystems.')

# References
doc.add_heading('References', 1)
doc.add_paragraph('1. DerSimonian R, Laird N. Meta-analysis in clinical trials. Controlled Clinical Trials. 1986.')
doc.add_paragraph('2. Gelman A, et al. Prior distributions for variance parameters in hierarchical models. Bayesian Analysis. 2006.')
doc.add_paragraph('3. IntHout J, et al. The Hartung-Knapp-Sidik-Jonkman method... BMC Med Res Methodol. 2014.')
