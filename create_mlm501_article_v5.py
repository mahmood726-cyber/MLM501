...
# Implementation & Figure Legends
doc.add_heading('Implementation & Software Architecture', 1)
doc.add_paragraph('MLM501 is implemented as an R-based evidence synthesis suite leveraging the metafor ecosystem for high-throughput frequentist modeling and brms/Stan for Bayesian posterior estimation. The package handles nested dependencies through a "nesting inflation" adjustment in the MAFI 2.0 engine.')
